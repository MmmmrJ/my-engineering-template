---
name: stock-learn-product-management
description: Turn Stock Learn product requests into scoped, testable specifications with user goals, stories, priorities, acceptance criteria, risks, and dependencies. Use when product behavior or delivery scope is new, ambiguous, or needs an executable product handoff. Do not use for ordinary explanations or already-specified implementation-only changes.
---

# Stock Learn Product Management
...
6. 标注数据来源、时效性、模拟环境和教育用途边界；不得把教学内容表述为投资建议或收益承诺。
